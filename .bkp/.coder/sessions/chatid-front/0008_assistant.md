Vamos corrigir o erro garantindo que a mensagem de resposta da IA seja renderizada corretamente no campo do chat. Parece que o problema está na forma como estamos acessando o conteúdo da resposta.
...
Com essas alterações, as mensagens enviadas e as respostas da IA devem ser renderizadas corretamente no campo do chat.